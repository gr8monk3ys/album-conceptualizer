...
from album_conceptualizer.agents.tools import MotifTrackerTool, NarrativeStructureSearchTool


def create_narrative_agent(
    narrative_search_tool: NarrativeStructureSearchTool | None = None,

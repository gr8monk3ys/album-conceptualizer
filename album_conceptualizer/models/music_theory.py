...
class Chord(BaseModel):
    ...
    bass_note: str | None = Field(default=None, description="Bass note for slash chords")
...
class ChordProgression(BaseModel):
    ...
    function_analysis: str | None = None
...
class EmotionMapping(BaseModel):
    ...
    harmonic_character: str | None = None
    dynamic_tendency: str | None = None

...
from album_conceptualizer.api.v1.audio_gen import router as audio_gen_router
...
subscription_router.include_router(audio_gen_router, prefix="/audio-gen", tags=["audio-generation"])

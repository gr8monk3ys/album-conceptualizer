...
class UnifiedRetriever:
    ...
    def retrieve_for_song_context(
        ...
        results["music_theory"] = self.music_theory_retriever.retrieve(theory_query, top_k=top_k)

        # Get narrative structure guidance
        narrative_query = f"Concept album song at {narrative_position} position"
        results["narrative"] = self.narrative_retriever.retrieve(narrative_query, top_k=top_k)

...
Narrative Structure: {structure_type}"""
    ...
    def index_structure_template(
        ...
        beats_text = "\n".join([f"- {b['name']}: {b['description']}" for b in beats])
        ...
        structures: list[dict[str, Any]] = [
            {
                ...
                "beats": [
                    {
                        "name": "Ordinary World",
                        "description": "Establish the protagonist's normal life",
                    },
                    {
                        "name": "Call to Adventure",
                        "description": "Disruption that initiates the journey",
                    },
                    ...
                    {"name": "Crossing the Threshold", "description": "Commitment to the journey"},
                    {
                        ...
                        "description": "Challenges and character development",
                    },
                    {
            ...
            },
            {
                ...
                "beats": [
                    {
                        "name": "Opening State",
                        "description": "Establish initial situation (will return here)",
                    },

  ...
  return (
    <div className="flex flex-col gap-5">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <div className="text-xs text-ink-3">Review inbox</div>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <section className="rounded-2xl border border-line bg-raised p-4">
          <div className="flex items-center justify-between gap-3">
            <div>
              <div className="text-xs text-ink-3">Comments</div>
              <div className="text-sm font-semibold text-ink">Unresolved</div>
            </div>
            <div className="text-xs text-ink-2">{commentCount}</div>
          </div>
          ...
          <div className="mt-3 space-y-2">
            {comments.length ? (
              ...
              <div className="rounded-2xl border border-line bg-sunken px-4 py-6 text-center text-sm text-ink-2">
        ...
        <section className="rounded-2xl border border-line bg-raised p-4">
          <div className="flex items-center justify-between gap-3">
            <div>
              ...
              <div className="text-sm font-semibold text-ink">Open</div>
            </div>
            <div className="text-xs text-ink-2">{taskCount}</div>
          </div>

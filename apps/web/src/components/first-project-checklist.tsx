 ...
 * it gets done. Finished rows stay in place, checked, so the order still reads as a path.
 */
              ...
              >
                ...
                <span className="min-w-0 flex-1">
                  <span
                    className={cn(
                      "block text-sm",
                      step.complete ? "text-ink-2" : "font-semibold text-ink",
                    )}
                  >
                    {step.label}
                  ...
                  <span
                    ...
                    className="mt-0.5 block text-xs leading-relaxed text-ink-3"
                  >
                    {step.description}
                  </span>
                </span>
                {isNext ? (
                  <span className="mt-0.5 shrink-0 text-xs font-semibold text-ink-2">Up next</span>
                ) : null}
                <ArrowRight

    ...
    with gr.Row():
        ...
        with gr.Column(scale=2):
            ...
            with gr.Group():
                ...
                gr.Markdown(
                    "*Visualization of the album's emotional/narrative journey*"
                )
                    ...
                    with gr.Row():
                        ...
                        components["section_type_select"] = gr.Dropdown(
                            choices=[
                                ...
                                "Post-Chorus", "Bridge", "Breakdown",
                                "Solo", "Interlude", "Outro", "Tag"
                            ],
                            label="Section Type",
                            value="Verse",
                        )
                ...
                with gr.Tab("Production"):
                    ...
                    components["instrumentation"] = gr.CheckboxGroup(
                        choices=[
                            ...
                            "Piano", "Synth", "Strings", "Brass", "Organ",
                            "Percussion", "Background Vocals", "Other"
                        ],

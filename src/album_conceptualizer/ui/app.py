...
from album_conceptualizer.models.music_theory import Chord, ChordProgression, Key
    ...
    with gr.Blocks(
        ...
        with gr.Tabs() as tabs:
            ...
            with gr.Tab("Album Canvas", id="canvas"):
                canvas_components = create_album_canvas()
            ...
            with gr.Tab("Song Editor", id="editor"):
                editor_components = create_song_editor()

            # Tab 4: Chord Tools
            with gr.Tab("Chord Tools", id="chords"):
                chord_components = create_chord_palette()

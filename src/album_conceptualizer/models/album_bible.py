...
class Theme(BaseModel):
    ...
    arc_description: Optional[str] = Field(
        default=None, description="How theme evolves across album"
    )
...
class Motif(BaseModel):
    ...
    chord_pattern: Optional[list[str]] = None
    melodic_contour: Optional[str] = None
    ...
    appearances: list[dict] = Field(
        ...
        description="List of {track_number, section, variation_notes}"
    )
    evolution_notes: Optional[str] = Field(
...
class Character(BaseModel):
    ...
    arc_summary: Optional[str] = Field(default=None, description="Character's journey")

    # Musical associations
    associated_key: Optional[str] = None
    associated_motif: Optional[str] = None
    vocal_style_notes: Optional[str] = None
...
class NarrativeArc(BaseModel):
    ...
    beats: list[dict] = Field(
        default_factory=list,
        description="List of {name, description, track_numbers}"
    )
    ...
    timeline_notes: Optional[str] = Field(
        default=None, description="Notes on non-linear timeline"
    )

    # Key moments
    inciting_incident: Optional[int] = Field(default=None, description="Track number")
    midpoint: Optional[int] = Field(default=None, description="Track number")
    climax: Optional[int] = Field(default=None, description="Track number")
    resolution: Optional[int] = Field(default=None, description="Track number")
...
class StyleProfile(BaseModel):
    ...
    # Lyrical style
    lyrical_tone: Optional[str] = Field(default=None, description="E.g., 'poetic', 'conversational'")
...
class AlbumBible(BaseModel):
    ...
    setting: Optional[str] = Field(default=None, description="Time/place of the story")
